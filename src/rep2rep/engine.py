...
from .data import Rep2RepDataset, make_loader, read_case, save_arrays, sigma_for_average
...
def train(configuration, resume=None):
    ...
    train_dataset = Rep2RepDataset(data_configuration["train"], training=True, **dataset_options)
    val_dataset = Rep2RepDataset(data_configuration["val"], training=False, **dataset_options)
...
def train_main(argv=None):
    parser = argparse.ArgumentParser(description="Train Rep2Rep with fixed rep0 input and rep1 target")
